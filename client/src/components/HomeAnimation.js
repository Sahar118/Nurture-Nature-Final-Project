    ...
    return (
        <div className='home-page'>
            <div className='back-img' >
                ...
                {/* <img className='cloud cloud3' src={cloud} alt='img' /> */}
